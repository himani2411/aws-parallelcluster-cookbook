...
ruby_block 'detect and configure proxy' do
  block do
    ...
    if proxy_ip
      ...
      no_proxy = "localhost,127.0.0.1,169.254.169.254,169.254.170.2,.s3.#{region}.amazonaws.com,s3.#{region}.amazonaws.com,.s3-#{region}.amazonaws.com,s3-#{region}.amazonaws.com"
